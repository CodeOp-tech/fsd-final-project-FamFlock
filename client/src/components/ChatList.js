...
function ChatList(props) {
  ...
  const [thumbsUpCount, setThumbsUpCount] = useState(0); // useState 1
  const [thumbsDownCount, setThumbsDownCount] = useState(0); // useState 2
